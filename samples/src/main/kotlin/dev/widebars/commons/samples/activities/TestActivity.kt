...
import dev.widebars.commons.adapters.MyRecyclerViewAdapter
import dev.widebars.commons.compose.extensions.config
import dev.widebars.commons.dialogs.WhatsNewDialog
import dev.widebars.commons.extensions.*
import dev.widebars.commons.models.Release
import dev.widebars.commons.samples.BuildConfig
import dev.widebars.commons.samples.R
import dev.widebars.commons.samples.adapters.TestAdapter
import dev.widebars.commons.samples.databinding.ActivityTestBinding
...
class TestActivity : BaseSimpleActivity() {
    ...
    private fun setupOptionsMenu() {
        binding.mainMenu.requireToolbar().inflateMenu(dev.widebars.commons.R.menu.cab_delete_only)
        binding.mainMenu.requireToolbar().setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                dev.widebars.commons.R.id.cab_delete -> showWhatsNewDialog()
