package dev.widebars.commons.helpers

import android.content.Context
import android.database.Cursor
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import dev.widebars.commons.extensions.getIntValue
import dev.widebars.commons.extensions.getStringValue
import dev.widebars.commons.models.PhoneNumber
import dev.widebars.commons.models.SimpleContact
import dev.widebars.commons.models.contacts.*
import androidx.core.net.toUri
import dev.widebars.commons.extensions.getStringValueOrNull
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "dev.widebars.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "dev.widebars.dialer" && packageName != "dev.widebars.smsmessenger" && packageName != "dev.widebars.calendar" &&
                packageName != "dev.widebars.dialer" && packageName != "dev.widebars.messages" && packageName != "dev.widebars.calendar"
            ) {
                return contacts
            }
