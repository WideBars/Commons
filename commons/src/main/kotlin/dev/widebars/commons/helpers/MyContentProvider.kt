...
object MyContentProvider {
    private const val AUTHORITY = "dev.widebars.android.provider"
    val MY_CONTENT_URI: Uri = "content://$AUTHORITY/settings".toUri()

    const val ACTION_GLOBAL_CONFIG_UPDATED = "dev.widebars.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "dev.widebars.android.permission.WRITE_GLOBAL_SETTINGS"

    const val COL_ID = "_id"    // used in WideBars Thank You
