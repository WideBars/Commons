...
import dev.widebars.commons.extensions.getDateTimeFromDateString
import dev.widebars.commons.extensions.showErrorToast
                ...
                contact.events.forEach { event ->
                    ...
                    when (event.type) {
                        ...
                        Event.TYPE_ANNIVERSARY -> {
                            ...
                            if (event.label == activity.getString(dev.widebars.strings.R.string.death)
