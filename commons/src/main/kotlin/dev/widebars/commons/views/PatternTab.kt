...
import dev.widebars.commons.databinding.TabPatternBinding
...
import dev.widebars.commons.helpers.PROTECTION_PATTERN
import dev.widebars.commons.interfaces.BaseSecurityTab
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(dev.widebars.strings.R.string.enter_pattern)
    }
