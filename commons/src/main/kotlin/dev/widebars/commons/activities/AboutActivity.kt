...
import dev.widebars.commons.compose.screens.*
import dev.widebars.commons.compose.theme.AppThemeSurface
import dev.widebars.commons.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : BaseComposeActivity() {
    ...
    private fun onPatreonClick() {
        launchViewIntent("https://www.patreon.com/cw/WideBars")
    }

    private fun onBuyMeaCoffeeClick() {
        launchViewIntent("https://buymeacoffee.dev/widebars")
    }
...
//        remember { !intent.getStringExtra(APP_REPOSITORY_NAME).isNullOrEmpty() }
    ...
    private fun getGithubUrl(): String {
        ...
        return "https://github.com/WideBars/$repositoryName"
    }
