...
import dev.widebars.commons.databinding.ActivityCustomizationBinding
import dev.widebars.commons.dialogs.*
import dev.widebars.commons.extensions.*
import dev.widebars.commons.helpers.*
import dev.widebars.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import dev.widebars.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import dev.widebars.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import dev.widebars.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import dev.widebars.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import dev.widebars.commons.helpers.MyContentProvider.COL_THEME_TYPE
import dev.widebars.commons.helpers.MyContentProvider.GLOBAL_THEME_AUTO
import dev.widebars.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import dev.widebars.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import dev.widebars.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import dev.widebars.commons.helpers.NavigationIcon
import dev.widebars.commons.helpers.SAVE_DISCARD_PROMPT_INTERVAL
import dev.widebars.commons.helpers.isSPlus
import dev.widebars.commons.models.GlobalConfig
import dev.widebars.commons.models.MyTheme
import dev.widebars.commons.models.RadioItem
import dev.widebars.commons.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("dev.widebars.", true) && baseConfig.appRunCount > 50 &&
            !packageName.startsWith("dev.widebars.", true) && baseConfig.appRunCount > 50
        ) {
            finish()
            return
        }

        if (!packageName.startsWith("dev.widebars")) {
