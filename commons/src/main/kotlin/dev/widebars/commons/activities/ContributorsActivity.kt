...
import dev.widebars.commons.compose.screens.ContributorsScreen
...
class ContributorsActivity : BaseComposeActivity() {
    ...
    private fun languageContributors() = listOf(
        ...
        LanguageContributor(R.drawable.ic_flag_brazil_vector, R.string.translation_brazil, R.string.translators_brazil),
        ...
        LanguageContributor(R.drawable.ic_flag_serbia_vector, R.string.translation_serbian, R.string.translators_serbian),
