package dev.widebars.commons.dialogs
...
import dev.widebars.commons.adapters.FilepickerFavoritesAdapter
import dev.widebars.commons.adapters.FilepickerItemsAdapter
import dev.widebars.commons.databinding.DialogFilepickerBinding
import dev.widebars.commons.extensions.areSystemAnimationsEnabled
import dev.widebars.commons.extensions.baseConfig
import dev.widebars.commons.extensions.beGone
import dev.widebars.commons.extensions.beVisible
import dev.widebars.commons.extensions.beVisibleIf
import dev.widebars.commons.extensions.getAlertDialogBuilder
import dev.widebars.commons.extensions.getAndroidSAFFileItems
...
import dev.widebars.commons.extensions.getDirectChildrenCount
import dev.widebars.commons.extensions.getDoesFilePathExist
import dev.widebars.commons.extensions.getFilenameFromPath
import dev.widebars.commons.extensions.getFolderLastModifieds
import dev.widebars.commons.extensions.getIsPathDirectory
import dev.widebars.commons.extensions.getOTGItems
import dev.widebars.commons.extensions.getParentPath
import dev.widebars.commons.extensions.getProperPrimaryColor
import dev.widebars.commons.extensions.getProperTextColor
import dev.widebars.commons.extensions.getSomeAndroidSAFDocument
import dev.widebars.commons.extensions.getSomeDocumentFile
import dev.widebars.commons.extensions.getSomeDocumentSdk30
import dev.widebars.commons.extensions.getTextSize
import dev.widebars.commons.extensions.handleHiddenFolderPasswordProtection
import dev.widebars.commons.extensions.handleLockedFolderOpening
import dev.widebars.commons.extensions.internalStoragePath
import dev.widebars.commons.extensions.isAccessibleWithSAFSdk30
import dev.widebars.commons.extensions.isInDownloadDir
import dev.widebars.commons.extensions.isPathOnOTG
import dev.widebars.commons.extensions.isRestrictedSAFOnlyRoot
import dev.widebars.commons.extensions.isRestrictedWithSAFSdk30
import dev.widebars.commons.extensions.isVisible
import dev.widebars.commons.extensions.setupDialogStuff
...
import dev.widebars.commons.views.Breadcrumbs
import java.io.File
